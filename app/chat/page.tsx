...
function ChatPage() {
  ...
  const startRecording = async () => {
    try {
      ...
      alert(tOrders("chat.microphone_error"));
    }
  };
              ...
              <div className="flex gap-2 relative">
                  ...
                  {showAttachmentMenu && (
                    <div className="absolute bottom-full mb-2 left-0 bg-[#2a2a2a] border border-gray-700 rounded-lg shadow-lg overflow-hidden">
                      <button
                        ...
                        className="cursor-pointer flex items-center gap-3 px-4 py-3 w-full hover:bg-[#3a3a3a] text-white transition-colors"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="cursor-pointer flex items-center gap-3 px-4 py-3 w-full hover:bg-[#3a3a3a] text-white transition-colors border-t border-gray-700"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      >
                        ...
                        <span className="text-sm">{tOrders("chat.voice")}</span>
                      </button>
                    </div>
                  )}
                </div>
                ...
                {isRecording && (
                  <button
                    ...
                    className="cursor-pointer px-4 py-3 bg-red-600 border border-red-700 text-white rounded-lg hover:bg-red-700 transition-colors animate-pulse"
                    title={tOrders("chat.stop_recording")}
                  >
